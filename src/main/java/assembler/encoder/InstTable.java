...
public class InstTable {
    ...
    public InstTable()
    {
        table = new HashMap<String, InstEntry>() {{
            ...
            put("br"    + "xxx"   + "rgi", new InstEntry(5,	-1,  FldConst.SRA,	 FldConst.COND,	  FldConst.XXX,	   FldConst.XXX)); // returns br [sra+imm] instead of brl [sra]
            put("break" + "xxx"   + "xxx", new InstEntry(0,	 4,	 FldConst.XXX,	 FldConst.XXX,	  FldConst.XXX,	   FldConst.XXX));
            put("brl"   + "xxx"   + "rgi", new InstEntry(7,	-1,	 FldConst.SRA,	 FldConst.COND,	  FldConst.XXX,	   FldConst.XXX)); // returns brl [sra+imm] instead of brl [sra]
            ...
            put("ld"    + "sbyte" + "rgi", new InstEntry(11, -1, FldConst.DRL,	 FldConst.SRA,	  FldConst.XXX,	   FldConst.XXX)); // returns ld drl, [sra+imm] instead of ld drl, [sra]
            put("ld"    + "ubyte" + "rgi", new InstEntry(15, -1, FldConst.DRL,	 FldConst.SRA,	  FldConst.XXX,	   FldConst.XXX)); // returns ld drl, [sra+imm] instead of ld drl, [sra]
            put("ld"    + "dword" + "rgi", new InstEntry(19, -1, FldConst.DRL,	 FldConst.SRA,	  FldConst.XXX,	   FldConst.XXX)); // returns ld drl, [sra+imm] instead of ld drl, [sra]
            put("ld"    + "sword" + "rgi", new InstEntry(23, -1, FldConst.DRL,	 FldConst.SRA,	  FldConst.XXX,	   FldConst.XXX)); // returns ld drl, [sra+imm] instead of ld drl, [sra]
            put("ld"    + "uword" + "rgi", new InstEntry(27, -1, FldConst.DRL,	 FldConst.SRA,	  FldConst.XXX,	   FldConst.XXX)); // returns ld drl, [sra+imm] instead of ld drl, [sra]
            put("mov"   + "xxx"   + "reg", new InstEntry(2,	 -1, FldConst.DRL,	 FldConst.SRA,	  FldConst.XXX,	   FldConst.XXX)); // returns add drl, sra, 0 instead of mov drl, srb
            ...
            put("st"    + "byte"  + "rgi", new InstEntry(35, -1, FldConst.SRA,	 FldConst.SRB,	  FldConst.XXX,	   FldConst.XXX)); // returns st [sra+imm], srb instead of st [sra], srb
            put("st"    + "dword" + "rgi", new InstEntry(39, -1, FldConst.SRA,	 FldConst.SRB,	  FldConst.XXX,	   FldConst.XXX)); // returns st [sra+imm], srb instead of st [sra], srb
            put("st"    + "word"  + "rgi", new InstEntry(43, -1, FldConst.SRA,	 FldConst.SRB,	  FldConst.XXX,	   FldConst.XXX)); // returns st [sra+imm], srb instead of st [sra], srb
